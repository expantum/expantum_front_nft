...
})()(
    {
      ...
      */
                    ...
                    init: function init() {
                        ...
                        if (
                            ...
                            swiper.pagination.$el.on(
                                'keydown',
                                (0, _utils.classesToSelector)(swiper.params.pagination.bulletClass),
        ...
        7: [
            ...
            { './getBreakpoint': 6, './setBreakpoint': 8 },
        ],
        8: [
            function (require, module, exports) {
                'use strict';
                ...
                function setBreakpoint() {
                    ...
                    if (breakpointOnlyParams) {
                        ['slidesPerView', 'spaceBetween', 'slidesPerGroup', 'slidesPerGroupSkip', 'slidesPerColumn'].forEach(function (
                            param
                        ) {
      ...
      support = swiper.support; // prettier-ignore
        ...
        11: [
            ...
            { './addClasses': 10, './removeClasses': 12 },
        ],
        12: [
            function (require, module, exports) {
                'use strict';
        ...
        13: [
                ...
                var Swiper = /*#__PURE__*/ (function () {
                    ...
                    _proto.emitContainerClasses = function emitContainerClasses() {
                        ...
                        var classes = swiper.el.className.split(' ').filter(function (className) {
                            return (
                                className.indexOf('swiper-container') === 0 || className.indexOf(swiper.params.containerModifierClass) === 0
                            );
                        });
            ...
            {
                '../../modules/observer/observer': 84,
                '../../modules/resize/resize': 85,
                '../../utils/dom': 86,
                '../../utils/get-browser': 87,
                '../../utils/get-device': 88,
                '../../utils/get-support': 89,
                '../../utils/utils': 90,
                './breakpoints/index': 7,
                './check-overflow/index': 9,
                './classes/index': 11,
                './defaults': 14,
                './events-emitter': 15,
                './events/index': 16,
                './grab-cursor/index': 23,
                './images/index': 26,
                './loop/index': 29,
                './manipulation/index': 35,
                './modular': 39,
                './slide/index': 40,
                './transition/index': 48,
                './translate/index': 53,
        ...
        21: [
            ...
            { '../../../utils/dom': 86, '../../../utils/utils': 90, 'ssr-window': 2 },
        ],
        22: [
            function (require, module, exports) {
                'use strict';
                ...
                function onTouchStart(event) {
                    ...
                    if (e.type !== 'touchstart') {
                        ...
                        if (
                            ...
                            (0, _dom.default)(document.activeElement).is(data.focusableElements) &&
        ...
        23: [
            ...
            { './setGrabCursor': 24, './unsetGrabCursor': 25 },
        ],
        24: [
            function (require, module, exports) {
                'use strict';
        ...
        29: [
            ...
            { './loopCreate': 30, './loopDestroy': 31, './loopFix': 32 },
        ],
        30: [
            function (require, module, exports) {
                'use strict';
                    ...
                    if (params.loopFillGroupWithBlank) {
                        ...
                        if (blankSlidesNum !== params.slidesPerGroup) {
                            for (var i = 0; i < blankSlidesNum; i += 1) {
                                var blankNode = (0, _dom.default)(document.createElement('div')).addClass(
        ...
        35: [
            ...
            { './addSlide': 33, './appendSlide': 34, './prependSlide': 36, './removeAllSlides': 37, './removeSlide': 38 },
        ],
        36: [
            function (require, module, exports) {
                'use strict';
        ...
        48: [
            ...
            { './setTransition': 49, './transitionEnd': 50, './transitionStart': 51 },
        ],
        49: [
            function (require, module, exports) {
                'use strict';
        ...
        53: [
            ...
            { './getTranslate': 52, './maxTranslate': 54, './minTranslate': 55, './setTranslate': 56, './translateTo': 57 },
        ],
        54: [
            function (require, module, exports) {
                'use strict';
        ...
        58: [
            ...
            {
                './updateActiveIndex': 59,
                './updateAutoHeight': 60,
                './updateClickedSlide': 61,
                './updateProgress': 62,
                './updateSize': 63,
                './updateSlides': 64,
                './updateSlidesClasses': 65,
                './updateSlidesOffset': 66,
                './updateSlidesProgress': 67,
            },
        ],
        59: [
            function (require, module, exports) {
      ...
      return property;
                            ...
                            if (params.slidesPerColumnFill === 'row' && params.slidesPerGroup > 1) {
                                ...
                                var columnsInGroup =
                                    groupIndex === 0
                                        ...
                                        : Math.min(
                                              Math.ceil(
                                                  (slidesLength - groupIndex * slidesPerColumn * params.slidesPerGroup) / slidesPerColumn
                                              ),
                                              params.slidesPerGroup
                                          );
                    ...
                    if (params.slidesPerColumn > 1) {
                        ...
                        $wrapperEl.css(
                            ((_$wrapperEl$css2 = {}),
                            (_$wrapperEl$css2[getDirectionLabel('width')] = swiper.virtualSize + params.spaceBetween + 'px'),
                            _$wrapperEl$css2)
                        );
                ...
                var Lazy = {
                    ...
                    load: function load() {
                        ...
                        function slideExist(index) {
                            if (isVirtual) {
                                if (
                                    $wrapperEl.children('.' + swiperParams.slideClass + '[data-swiper-slide-index="' + index + '"]').length
                                ) {
                                    return true;
                                }
                    ...
                    on: {
                        ...
                        slideChange: function slideChange(swiper) {
                            ...
                            if (
                                lazy.enabled &&
                                (cssMode ||
                                    ((watchSlidesVisibility || watchSlidesProgress) && (touchReleaseOnEdges || resistanceRatio === 0)))
                            ) {
                                swiper.lazy.load();
                            }
                        },
                ...
                var Mousewheel = {
                    ...
                    animateSlider: function animateSlider(newEvent) {
                        ...
                        if (
                            ...
                            (0, _utils.now)() - swiper.mousewheel.lastScrollTime < this.params.mousewheel.thresholdTime
                        ) {
                ...
                var Pagination = {
                    update: function update() {
                        ...
                        if (params.type === 'progressbar') {
                            ...
                            $el.find((0, _utils.classesToSelector)(params.progressbarFillClass))
                    ...
                    on: {
                        ...
                        click: function click(swiper, e) {
                            ...
                            if (
                                ...
                                !(0, _dom.default)(targetEl).hasClass(swiper.params.pagination.bulletClass)
                            ) {
                                if (
                                    swiper.navigation &&
        ...
        90: [
            function (require, module, exports) {
                ...
                function isObject(o) {
                    return (
                        typeof o === 'object' && o !== null && o.constructor && Object.prototype.toString.call(o).slice(8, -1) === 'Object'
                    );
                }
        ...
        91: [
            function (require, module, exports) {
                ...
                var components = [
                    ...
                    Keyboard__default['default'],
                    Mousewheel__default['default'],
                    Navigation__default['default'],
                    Pagination__default['default'],
                    Scrollbar__default['default'],
                    Parallax__default['default'],
                    Zoom__default['default'],
                    Lazy__default['default'],
                    Controller__default['default'],
                    A11y__default['default'],
                    History__default['default'],
                    HashNavigation__default['default'],
                    Autoplay__default['default'],
                    EffectFade__default['default'],
                    EffectCube__default['default'],
                    EffectFlip__default['default'],
                    EffectCoverflow__default['default'],
                    Thumbs__default['default'],
                ];
            ...
            {
                './cjs/components/a11y/a11y': 3,
                './cjs/components/autoplay/autoplay': 4,
                './cjs/components/controller/controller': 5,
                './cjs/components/core/core-class': 13,
                './cjs/components/effect-coverflow/effect-coverflow': 68,
                './cjs/components/effect-cube/effect-cube': 69,
                './cjs/components/effect-fade/effect-fade': 70,
                './cjs/components/effect-flip/effect-flip': 71,
                './cjs/components/hash-navigation/hash-navigation': 72,
                './cjs/components/history/history': 73,
                './cjs/components/keyboard/keyboard': 74,
                './cjs/components/lazy/lazy': 75,
                './cjs/components/mousewheel/mousewheel': 76,
                './cjs/components/navigation/navigation': 77,
                './cjs/components/pagination/pagination': 78,
                './cjs/components/parallax/parallax': 79,
                './cjs/components/scrollbar/scrollbar': 80,
                './cjs/components/thumbs/thumbs': 81,
                './cjs/components/virtual/virtual': 82,
                './cjs/components/zoom/zoom': 83,
            },
        ],
        92: [
            function (require, module, exports) {
        ...
        93: [
            function (require, module, exports) {
                ...
                function initSwiper() {
                    var swiper = new _bundle['default']('.js-swiper-container', {
                        effect: 'coverflow',
                        centeredSlides: true,
                        slidesPerView: 1,
                        loop: true,
